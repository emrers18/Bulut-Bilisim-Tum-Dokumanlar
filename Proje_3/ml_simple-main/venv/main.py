...
# MongoDB Bağlantısı - TLS hatasını önlemek için sertifika doğrulaması kapatıldı
client = MongoClient(
    "mongodb+srv://emrersinn00:IDl5GpJHazBR7TY0@mlsimple.slki97k.mongodb.net/ml_simple?retryWrites=true&w=majority&appName=mlSimple",
    tls=True,
